import { publicSchemas, secureSchemas } from './schemas/index';
...
const buildSchema = (allSchemas: ISchema[]  ) => {
  ...
  return schemaWithCustomDirectives;
}

export const secureSchema = () => (buildSchema(secureSchemas));
export const publicSchema = () => (buildSchema(publicSchemas));
