...
exports.generatePlatformSettings = void 0;
var settings = [{
        key: "url_mapping",
        value: {
...
function generatePlatformSettings(prisma) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Generate Users seeding ...");
                    return [4 /*yield*/, prisma.platformSettings.createMany({
                            data: settings,
                            skipDuplicates: true
                        })];
                case 1:
...
exports.generatePlatformSettings = generatePlatformSettings;
